"""Alembic migration environment (sync, SQLite-batch enabled).

Loads the SQLAlchemy metadata + URL from the app's db package so migrations and
models never drift.
"""
...
from db.base import Base, SYNC_DATABASE_URL  # noqa: E402
