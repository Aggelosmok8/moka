...
LEAGUE_CATALOG: List[League] = [
    ...
    League("uecl", "UEFA Conference League", Sport.FOOTBALL),
    League("facup", "FA Cup (England)", Sport.FOOTBALL),
    League("eflcup", "EFL Cup (England)", Sport.FOOTBALL),
    League("copadelrey", "Copa del Rey (Spain)", Sport.FOOTBALL),
    League("coppaitalia", "Coppa Italia (Italy)", Sport.FOOTBALL),
