  ...
  return (
    ...
    >
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        <Link to="/" data-testid="logo-link" data-no-translate className="flex items-center group shrink-0">
          <img src="/lion-logo.png" alt="LION.STATS" className="h-10 w-auto sm:hidden object-contain" />
          <img src="/lion-logo-full.png" alt="LION.STATS" className="hidden sm:block h-11 lg:h-12 w-auto object-contain group-hover:scale-[1.03] transition-transform" />
        </Link>
