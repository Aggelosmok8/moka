        ...
        >
          ...
          >
            ...
            <input
              ...
              data-testid="portfolio-stake-input"
              autoFocus
            ...
            <div className="flex gap-2 mt-2">
              {CHIPS.map((c) => (
                <button key={c} type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setStake(String(c)); }}
                  className="flex-1 py-1.5 rounded-md text-xs font-bold bg-white/5 text-zinc-300 border border-white/10 hover:bg-white/10">
                  €{c}
                </button>
              ))}
            </div>
            ...
            <button
              onClick={confirm}
              data-testid="portfolio-confirm-add"
